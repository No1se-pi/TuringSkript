...
if choise == 1:
    ...
    phone_num = input("введите номер телефона получателя(Без пробелов и скобок): ")
    print("\n")
    
    # Убирает + из номера телефона
    if phone_num[0] == "+":
    ...
    key_one = messege_size  # Первый ключ - это размер сообщения

    counter,counter2=0,0
    
    key_two =0 # Второй ключ - цыфорки цыфорки
    key_three = 0 
#__________________________________________________________________________________________________________________________________________   
